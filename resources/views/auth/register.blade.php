                  ...
                  <div class="card-body">
                      <form method="POST" action="{{ route('register') }}">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="phone_no" type="text" class="form-control" name="phone_no" value="{{ old('phone_no') }}" required autocomplete="email">
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                <select  name="division">
                                  ...
                                  <option value="{{ $disvision->id }}">{{ $disvision->name }}</option>
                                  @endforeach
                                </select>
                              </div>
                          </div>
